...
public class ReactorRenderer extends JFrame{
    ...
    public void paint(Graphics g){
        ...
        for (int i = 0; i < building.neuts.size(); i++) {
            ...
            (int)((n.origin.x+n.dir.x*n.lastAABBIntersection.tmin()-xoffset*building.reactor.length/100.0)*rectsize)+400,(int)((n.origin.y+n.dir.y*n.lastAABBIntersection.tmin()-yoffset*building.reactor.length/100.0)*rectsize)+400);
        }
